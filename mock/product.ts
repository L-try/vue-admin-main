 ...
 * @Date: 2024-03-21
 */
const appleLogo = '../src/assets/product/apple.jpg'
const appleLogo1 = '../src/assets/product/apple-1.jpg'
const HuaweiLogo = '../src/assets/product/huawei.png'
const appleLogo2 = '../src/assets/product/appleAll.jpg'
// 模拟商品数据
const productList = [
  {
    id: 1,
...
const skuList = [
  {
    ...
    skuImageList: [
      ...
      {
        id: 2,
        imgName: 'iPhone 15 Pro 256GB 深空蓝',
        imgUrl: appleLogo1,
        skuId: 1,
        spuImgId: 1,
      },
      {
        id: 3,
        imgName: 'iPhone 15 Pro 256GB 深空白',
        imgUrl: appleLogo2,
        skuId: 1,
        spuImgId: 1,
      },
